...
function App(){
 ...
 const toggleSound=async(checked:boolean)=>{if(!checked){setSound(false);return}await getAudio();setSound(true);await Promise.all([playTone(392,true,0),playTone(523.25,true,.16),playTone(659.25,true,.34)])};
